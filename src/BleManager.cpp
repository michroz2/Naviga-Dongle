 ...
 * File: BleManager.cpp
 * Version: 1.46.5
 * Изменение: Реализация симметричной выгрузки координат и новых дельта-методов (0x15, 0x16).
...
// НОВОЕ 1.46.5: Реализация дельта-обновления координат
...
// НОВОЕ 1.46.5: Реализация дельта-обновления информации об узле
